      ...
      <div className="max-w-md mx-auto">
        <div className="flex justify-center block lg:flex bg-white lg:shadow-lg rounded-lg">
          <div className="w-full px-6 py-16">
            <div className="mb-4 font-light tracking-widest text-2xl">SIGN UP</div>
            ...
            <span className="ml-2">I want to remember you ?</span>
              ...
              <div className="block md:flex items-center justify-center">
                <button type="submit" className="min-w-full align-middle bg-blue-500 hover:bg-blue-600 text-center px-4 py-2 text-white text-sm font-semibold rounded-lg inline-block shadow-lg">Sign up</button>
